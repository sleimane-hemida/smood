          ...
          <div className="container">
            <div className="about-content">
              ...
              <div className="about-image">
                <img src="/assets/smood.jpeg" alt="Équipe de développement SMOOD Tech avec projets" width="600" height="400" loading="lazy" />
                <img src="/assets/smood2.png" alt="Équipe de développement SMOOD Tech technique" width="600" height="400" loading="lazy" />
              </div>
            </div>
          </div>
        </section>
