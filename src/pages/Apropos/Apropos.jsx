      ...
      <main role="main">
        ...
        <section className="founders-carousel" role="region" aria-label="Nos Fondateurs">
          <div className="carousel-container">
            {/* Slide 1 - Sleimane Hemida */}
            <div className="founder-slide active" data-founder="1">
              <div className="founder-image">
                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=1600&q=80" alt="Sleimane Hemida" />
                <div className="founder-overlay"></div>
              </div>
              <div className="founder-content">
                <div className="founder-number">01</div>
                <h2 className="founder-name">Sleimane Hemida</h2>
                <p className="founder-role">Développeur Spécialiste</p>
                <p className="founder-specialty">Prototype UI/UX</p>
                <div className="founder-description">
                  <p>Expert en conception d'interfaces utilisateur et prototypage. Maître des outils comme Figma et Adobe XD, Sleimane transforme les idées en expériences visuelles captivantes et fonctionnelles.</p>
                </div>
                <div className="founder-skills">
                  <span className="skill-tag">UI/UX Design</span>
                  <span className="skill-tag">Figma</span>
                  <span className="skill-tag">Adobe XD</span>
                  <span className="skill-tag">Prototypage</span>
                </div>
              </div>
            </div>

            {/* Slide 2 - Mamoudou Touré */}
            <div className="founder-slide" data-founder="2">
              <div className="founder-image">
                <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1600&q=80" alt="Mamoudou Touré" />
                <div className="founder-overlay"></div>
              </div>
              <div className="founder-content">
                <div className="founder-number">02</div>
                <h2 className="founder-name">Mamoudou Touré</h2>
                <p className="founder-role">Développeur Spécialiste</p>
                <p className="founder-specialty">Réseau & Administration</p>
                <div className="founder-description">
                  <p>Architecte réseau chevronné, Mamoudou assure la sécurité et l'efficacité de nos infrastructures. Expert en administration système et configurations réseau complexes.</p>
                </div>
                <div className="founder-skills">
                  <span className="skill-tag">Réseau</span>
                  <span className="skill-tag">Administration</span>
                  <span className="skill-tag">Sécurité</span>
                  <span className="skill-tag">Infrastructure</span>
                </div>
              </div>
            </div>

            {/* Slide 3 - Oumou Diop */}
            <div className="founder-slide" data-founder="3">
              <div className="founder-image">
                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1600&q=80" alt="Oumou Diop" />
                <div className="founder-overlay"></div>
              </div>
              <div className="founder-content">
                <div className="founder-number">03</div>
                <h2 className="founder-name">Oumou Diop</h2>
                <p className="founder-role">Développeuse Spécialiste</p>
                <p className="founder-specialty">Technologies Sophistiquées</p>
                <div className="founder-description">
                  <p>Pionnière des technologies avancées, Oumou intègre les solutions les plus innovantes dans nos projets. Spécialiste en IA, machine learning et architectures modernes.</p>
                </div>
                <div className="founder-skills">
                  <span className="skill-tag">IA & ML</span>
            ...
            {/* Slide 4 - Omar Sall */}
            <div className="founder-slide" data-founder="4">
              <div className="founder-image">
                <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=1600&q=80" alt="Omar Sall" />
                <div className="founder-overlay"></div>
              </div>
              <div className="founder-content">
                <div className="founder-number">04</div>
                <h2 className="founder-name">Omar Sall</h2>
                <p className="founder-role">Développeur Spécialiste</p>
                <p className="founder-specialty">Réseau & Administration</p>
                <div className="founder-description">
                  <p>Expert en infrastructures réseau et systèmes distribués. Omar garantit la performance et la fiabilité de nos solutions avec une expertise en DevOps et administration système.</p>
                </div>
                <div className="founder-skills">
            ...
            {/* Slide 5 - Diye Ba */}
            <div className="founder-slide" data-founder="5">
              <div className="founder-image">
                <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=1600&q=80" alt="Diye Ba" />
                <div className="founder-overlay"></div>
              </div>
              <div className="founder-content">
                <div className="founder-number">05</div>
                <h2 className="founder-name">Diye Ba</h2>
                <p className="founder-role">Développeuse Spécialiste</p>
                <p className="founder-specialty">Technologies Sophistiquées</p>
                <div className="founder-description">
                  <p>Visionnaire technologique, Diye repousse les limites du possible. Experte en développement full-stack et architectures microservices, elle façonne l'avenir de nos applications.</p>
                </div>
                <div className="founder-skills">
            ...
            <div className="carousel-dots">
              <button className="dot active" data-slide="1" aria-label="Fondateur 1"></button>
              <button className="dot" data-slide="2" aria-label="Fondateur 2"></button>
              <button className="dot" data-slide="3" aria-label="Fondateur 3"></button>
              <button className="dot" data-slide="4" aria-label="Fondateur 4"></button>
              <button className="dot" data-slide="5" aria-label="Fondateur 5"></button>
            </div>
          ...
          <div className="contact-container">
            ...
            <div className="contact-wrapper">
              ...
              <div className="contact-form-wrapper">
                <form action="#" method="post" className="modern-contact-form">
